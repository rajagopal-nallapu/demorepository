...
-- Generation Time: Feb 01, 2019 at 08:56 AM
...
--
-- Database: `crcloud_skeleton_aus_crd`
--
...
(1, 'Veda', 'veda.png', 'Veda Advantage \r\nPO Box 964 North Sydney,\r\nNSW, 2059\r\nAtlanta, GA 30374', NULL, '1'),
(2, 'Dun & Bradstreet', 'dnb.png', 'Dun & Bradstreet (Australia)\r\nP/L PO Box 7405 St\r\nKilda Road VIC 3004', '2012-11-08', '1'),
(3, '', '', '', NULL, '0');
...
ALTER TABLE `crd_clients_onboarding`
  ...
  ADD KEY `obid_2` (`obid`,`iclient_id`,`tokan`);
